        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Danh sách danh mục bài đăng</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <?php }?>
        ...
        <div class="card card-default">
            <div class="card-header">
                <h3 class="card-title">Tổng số <?=count($dataItem)?> danh mục</h3>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Sửa, xóa danh sách danh mục bài đăng</h3>
                                <div class="card-tools">
                                      ...
                                      <?php foreach($dataItem as $key => $value){?>
                                        ...
                                        <tr id="<?=$value['id']?>">
                                                ...
                                                <td class="project-actions text-right">
                                                    ...
                                                    <a class="btn btn-info btn-sm" href="edit/<?=$value['slug']?>">
            ...
            <div class="card-footer">
                ...
                <a href="/admin/category-post/add" class=""><button type="button" class="btn btn-success m-2">Nhập thêm</button></a>
            </div>
...
<script>
 var idDelete = false;
    function deleteAjax(dataPayload) {
        $.ajax({
                method: "POST",
                url: "/admin/category-post/delete",
                data: {
                    arr: dataPayload,
                }
            })
