    ...
    <div class="container-fluid">
      ...
      <?= isset($errors) ? ' <div class="alert alert-danger"> <span class="">Lỗi</span></div>' : ''?>
        ...
        <div class="card card-default">
            ...
            <form id="submit-form" action="/admin/category-post/add" method="POST">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                ...
                <div class="card-footer">
                    ...
                    <a href="/admin/category-post/add" class=""> <button type="button" class="btn btn-danger m-2">Nhập lại</button></a>
