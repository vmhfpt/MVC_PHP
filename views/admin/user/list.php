    ...
    <?php }?>
        <div class="card card-default">
            <div class="card-header">
                <h3 class="card-title">Tổng số <?=count($dataItem)?> khách hàng</h3>
                            ...
                            <div class="card-body">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                            ...
                                            <td><?=$value['email']?></td>
                                            <td><?=$value['image'] ? '<img src="'.IMAGE_DIR_USER.$value['image'].'" style="width : 80px; height : 80px"  />' : '<img src="https://cdn-icons-png.flaticon.com/512/149/149071.png" style="width : 80px; height : 80px"  />' ?></td>
                                            <td class="project-state">
                                            <?=$value['role'] == 1 ? '<span class="badge badge-success">Nhân viên</span>' : '<span class="badge badge-danger">Khách hàng</span>'?>
            ...
            <div class="card-footer">
                ...
                <a href="add" class=""> <button type="button" class="btn btn-success m-2">Nhập thêm</button></a>
            </div>
