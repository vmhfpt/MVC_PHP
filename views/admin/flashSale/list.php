        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Danh sách Flash Sales</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <?php }?>
        ...
        <div class="card card-default">
            <div class="card-header">
                <h3 class="card-title">Tổng số  <?=count([])?> sản phẩm thuộc danh sách flash sales</h3>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Sửa, xóa danh sách sản phẩm flash sales</h3>
                                <div class="card-tools">
                                    ...
                                    <tbody>
                                      <?php foreach($dataItem as $key => $value){?>
                                        ...
                                        <tr id="<?=$value['id']?>">
                                                ...
                                                <td><?=$value['discount_new']?> <-> (<?=(float) $value['discount_new'] * 100?>%)</td>
                                                <td><?=currency_format($value['price'] - ($value['price'] * $value['discount_new']))?></td>
            ...
            <div class="card-footer">
                ...
                <a href="/admin/flashsale/add" class=""><button type="button" class="btn btn-success m-2">Nhập thêm</button></a>
            </div>
