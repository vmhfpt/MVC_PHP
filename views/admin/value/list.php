...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Danh sách giá trị biến thể (giá trị thuộc tính sản phẩm)</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="index.php">Trang chủ</a></li>
                    <li class="breadcrumb-item active">Danh sách giá trị biến thể</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <?php }?>
        ...
        <div class="card card-default">
            <div class="card-header">
                <h3 class="card-title">Tổng số <?=count($dataItem)?> giá trị biến thể</h3>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Sửa, xóa danh sách giá trị</h3>
                                <div class="card-tools">
                                    ...
                                    <tbody id="result">
                                      <?php foreach($dataItem as $key => $value){?>
                                        ...
                                        <tr id="<?=$value['id']?>">
                                                ...
                                                <td class="ten_loai text-danger"><?=$value['value']?></td>
            ...
            <div class="card-footer">
                ...
                <a href="/admin/value/add" class=""><button type="button" class="btn btn-success m-2">Nhập thêm</button></a>
            </div>
...
<script>
 var idDelete = false;
    ...
    $('.type-id').change(function() {
        $.ajax({
                method: "POST",
                url: "/admin/attribute/get-list/ajax",
                data: {
                    id: Number($(this).val()),
                }
            })
            .done(function(msg) {
                ...
                msg.map((value, key) => {
                    $('#result').append(`   <tr id="${value.id}">
                                                ...
                                                <td class="ten_loai">${value.value}</td>
                                                <td class="project-actions text-right">
