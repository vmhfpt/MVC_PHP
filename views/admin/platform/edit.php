...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Sửa nền tảng "<?=$item['name']?>" </h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="index.php">Trang chủ</a></li>
                    <li class="breadcrumb-item active">Sửa nền tảng</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <?= isset($errors) ? '<div class="alert alert-danger"> <span class="">Lỗi</span></div>' : ''?>
        ...
        <div class="card card-default">
            ...
            <form id="submit-form" action="" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="code">MÃ NỀN TẢNG (Tự động tăng)</label>
                                <input type="text" class="form-control" id="code" placeholder="Mã nền tảng tự động tăng" disabled>
                            </div>

                            <div class="form-group">
                                <label for="name-category">TÊN NỀN TẢNG</label>
                ...
                <a href="/admin/platform/list" class=""> <button type="button" class="btn btn-success m-2">Danh sách</button></a>
            </div>
            </form>
