    ...
    <?php }?>
        ...
        <div class="card card-default">
            <div class="card-header">
                <h3 class="card-title">Tổng số  <?=count($dataItem)?> mã giảm giá</h3>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Sửa, xóa danh sách mã giảm giá</h3>
                                <div class="card-tools">
                                    ...
                                    <tbody>
                                      <?php foreach($dataItem as $key => $value){?>
                                        ...
                                        <tr id="<?=$value['id']?>">
                                                ...
                                                <td><?= $value['type'] == 0 ? '<span class="badge bg-primary">Phần trăm</span>': '<span class="badge bg-success">Giá</span>'?></td>
            ...
            <div class="card-footer">
                ...
                <a href="/admin/coupon/add" class=""><button type="button" class="btn btn-success m-2">Nhập thêm</button></a>
            </div>
