    ...
    <?php }?>
        <div class="card card-default">
            <div class="card-header">
                <h3 class="card-title">Tổng số <?=count($dataItem)?> bài viết</h3>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Sửa, xóa danh sách bài viết</h3>
                                <div class="card-tools">
                                    ...
                                    <tbody>
                                      <?php foreach($dataItem as $key => $value){?>
                                        <tr id="<?=$value['id']?>" >
                                            ...
                                            <td><?=$value['id']?></td>
                                            <td class="ten_loai" ><?=$value['title']?></td>
                                            <td><?=$value['category_name']?></td>
                                            <td><img src="<?=IMAGE_DIR_POST.$value['thumb']?>" style="width : 80px; height : 80px"  /></td>
                                         
                                            <td class="project-actions text-right">
                                               
                                                <a class="btn btn-info btn-sm" href="/admin/post/edit/<?=$value['slug']?>">
            ...
            <div class="card-footer">
                ...
                <a href="/admin/post/add" class=""> <button type="button" class="btn btn-success m-2">Nhập thêm</button></a>
            </div>
