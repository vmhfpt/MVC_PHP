    ...
    <?= isset($errors) ? ' <div class="alert alert-danger"> <span class="">Lỗi</span></div>' : ''?>
        ...
        <div class="card card-default">
            ...
            <form id="submit-form" action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input value="<?=$item['title']?>" name="title" type="text" class="form-control" id="giam_gia" placeholder="Nhập tiêu đề">
                                <?= isset($errors['title']) ? '<span id="error-name" class="text-danger">'.$errors['title'].'</span>' : ''?>
                            </div>
                            <div class="form-group">
                                <label>DANH MỤC BÀI VIẾT</label>
                                <select name="category_post_id" class="custom-select">
                                        <?php foreach($listCategory as $key => $value){?>
                                            <option  <?= $item['category_post_id'] == $value['id'] ? 'selected' : ''?> value="<?=$value['id']?>"><?=$value['name']?></option>
                                        <?php }?>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input value="<?=$item['description']?>" name="description" type="text" class="form-control" id="name" placeholder="Nhập mô tả bài viết">
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-6">
                            ...
                            <div class="filtr-item col-sm-4" data-category="1" data-sort="white sample">
                                <img id="#imgSrc" src="<?=IMAGE_DIR_POST.$item['thumb']?>" class="img-fluid mb-2" alt="white sample" />
                            </div>
                ...
                <a href="/admin/post/list" class=""> <button type="button" class="btn btn-success m-2">Danh sách</button></a>
            </div>
            </form>
