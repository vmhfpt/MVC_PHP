...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown user-menu">
                    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                        <img src="https://haycafe.vn/wp-content/uploads/2021/12/Anh-thien-nhien-dep-va-tran-ngap-suc-song.jpg" class="user-image img-circle elevation-2" alt="User Image">
                        <span class="d-none d-md-inline">Vu Minh Hung</span>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">

                        <li class="user-header bg-primary">
                            <img src="https://haycafe.vn/wp-content/uploads/2021/12/Anh-thien-nhien-dep-va-tran-ngap-suc-song.jpg" class="img-circle elevation-2" alt="User Image">
                            <p>
                            Hung Vu- Nguyễn Thành Long
                                <small>vuminhungltt904@gmail.com</small>
                            </p>
                        </li>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="" class="brand-link">
                <img src="https://haycafe.vn/wp-content/uploads/2021/12/Anh-thien-nhien-dep-va-tran-ngap-suc-song.jpg" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="/admin/platform/list" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="/admin/inventory/add" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Thêm sản phẩm</p>
                                    </a>
                                </li>
        ...
        <div class="content-wrapper content-wrapper-remove" >
