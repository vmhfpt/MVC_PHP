                ...
                <div class="col-md-3 col-sm-6 support-paying">
                    <div class="app-footer-item">
                        <ul>
                            ...
                            <li><a href="/trang-chinh/?gioi-thieu">Giới thiệu công ty</a></li>
                            <li><a href="/trang-chinh/?cua-hang">Hệ thống cửa hàng</a></li>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="app-footer-item">
                        <ul>
                            ...
                            <li><a href="/introduce/chinh-sach-doi-tra">Chính sách đổi trả</a></li>
                            <li><a href="/introduce/thoa-thuan">Thảo thuận</a></li>
                            <li><a href="/introduce/huong-dan-mua-hang">Hướng dẫn mua hàng</a></li>
                            <li><a href="/introduce/noi-quy-cua-hang">Nội quy cửa hàng</a></li>
                            <li><a href="/introduce/ve-cong-ty">Về công ty</a></li>
                            <li><a href="/introduce/chinh-sach-bao-mat">Chính sách bảo mật</a></li>
                            <li><a href="/introduce/chinh-sach-bao-hanh">Chính sách bảo hành</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                    <div class="app-footer-item">
                        <ul>
                            ...
                            <li><a href="/introduce/chinh-sach-su-dung">Chính sách sử dụng</a></li>
...
.chatbot-result td, th {
  border: 1px solid #dddddd;
  text-align: left;
  padding: 5px;
}

.chatbot-result tr:nth-child(even) {
  background-color: #dddddd;
}
.order-information-result li {
    margin : 3px 0px;
}
.product-information {
    gap : 5px;
...
//         checkLogin(); 
    ...
    //                              Xin chào đến với phẩn chat trực tuyến của chúng tôi. <br/> <br/> 
    //                              - Vui lòng để lại thông tin hoặc cung cấp chi tiết vấn đề của bạn  <br/> <br/> 


    //                             <div class="list-chat-suggest">
    //                                 <span class="chat-suggest"> Tra cứu đơn hàng : Mã đơn hàng</span>
    //                                 <span class="chat-suggest"> Tra cứu sản phẩm : Tên sp</span>
    //                             </div>
    ...
    //     $(document).on("click", ".chat-suggest", function() {
    //          let text = $(this).text();
    //          let newStr = text.split(':')[0].trim();
    //          $('#input-post').val(newStr  + ': ');
                
            
            
    //     });
    //     function chatBot(value){
    //          if(value.includes("Tra cứu đơn hàng")){
    //             let newStr = value.split(':')[1].trim();
    //             $.ajax({
    //              method: "POST",
    //              url: "/api/chatbot/get-order",
    //              data: {
    //                  code : newStr, 
    //              }
    //          })
    ...
    //          }else if(value.includes("Tra cứu sản phẩm")){
    //                 let newStr = value.split(':')[1].trim();
    //                 $.ajax({
    //                 method: "POST",
    //                 url: "/api/chatbot/get-product",
    //                 data: {
    //                     name : newStr,
    //                 }
    //             })
